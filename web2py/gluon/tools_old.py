...
class Auth(object):
    ...
    def __init__(self, environment=None, db=None, mailer=True,
        ...
        messages.register_button = 'Join us!'
...
# Customized fields by JM -   10/5/2011                                      
                    Field('buyers_id', length=512,
                          writable=False, readable=False, default='',
                          label=self.messages.label_buyers_id),
                    ...
                    Field('user_image', length=512,
                          writable=False, readable=False, default='',
                          label=self.messages.label_user_image),
