...
#
default_application = 'JamesRhysSite'    # ordinarily set in base routes.py
...
routes_in = ((r'.*:/favicon.ico', r'/examples/static/favicon.ico'),
             (r'.*:/robots.txt', r'/examples/static/robots.txt'),
             (r'/$c/$f',r'/JamesRhysSite/$c/$f'), # Replace with default_application
             #(r'.*/sellerhq/', r'/OJTest/sellerHQ/index'), 
...
routes_out = ((r'.*http://otherdomain.com.* /app/ctr(?P<any>.*)', r'\g<any>'),
              (r'/app(?P<any>.*)', r'\g<any>'),
              (r'/JamesRhysSite/$c/$f',r'/$c/$f'), # Replace with default_application
              )
